...
public class SegundoActivity extends AppCompatActivity {
    ...
    private Spinner spinnerTema, spinnerTono;
    private String botonPrivacidad = "Desactivado", botonBateria = "Desactivado",
            tema = "Silver", tono = "Bell", opcion = "Automático";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] listaTema = {"Gold", "Light", "Blue", "Silver"};
        ...
        spinnerTema = (Spinner) findViewById(R.id.spinner);
        ...
        spinnerTema.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tema = (String) parent.getItemAtPosition(position);
            }
        ...
        final ArrayAdapter<CharSequence> adapterTono = ArrayAdapter.createFromResource(this,
                R.array.valores_array,
                android.R.layout.simple_spinner_item);
        spinnerTono = (Spinner) findViewById(R.id.spinner2);
        spinnerTono.setAdapter(adapterTono);

        spinnerTono.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                tono = (String) parent.getItemAtPosition(position);
            }

            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                tono = "No se ha seleccionado nada";
            }
        });
        ...
        restaurar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int spinnerPositionTema = adapter.getPosition("Silver");
                spinnerTema.setSelection(spinnerPositionTema);
                int spinnerPositionTono = adapterTono.getPosition("Bell");
                spinnerTono.setSelection(spinnerPositionTono);
            }
        });
